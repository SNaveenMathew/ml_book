...
For a function $f$ of $w \in R^{1}$ that is minimized at $\hat{w}$, the necessary second order condition is $\bigg[\frac{\partial^2 f}{\partial w^2}\bigg]_{w=\hat{w}} \ge 0$ (strict > is sufficient, but not necessary for minimality). For the loss function in equation $2.1.2.1.1.b$ we know that $\bigg[\frac{\partial^2 f}{\partial w^2}\bigg]_{w=\hat{w}} > 0$. Differentiating equation $2.1.2.1.1.b$ with respect to $W^T$ we get:
