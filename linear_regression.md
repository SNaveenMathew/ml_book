...
$$\bigg[\frac{\partial L}{\partial w_j}\bigg]_{w_j = w_j(1)} = \lim_{h \to 0} \frac{L(w_j = w_j(1) + h, w_{-j}) - L(w_j = w_j(1), w_{-j})}{h} \approx \frac{L(w_j = w_j(1) + \delta h, w_{-j}) - L(w_j = w_j(1), w_{-j})}{\delta h}$$
